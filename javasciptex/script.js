...
//use filter to return a user id related to the name 
//and return the userid 
const ReturnMarshalid = (users) =>{
    
    const arr = users.filter((user) => user.firstName === "Madison" && user.lastName === "Marshall")
    return {...arr}
}
console.log(ReturnMarshalid(users))
